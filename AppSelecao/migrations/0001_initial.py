    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequencia_extensionista', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='AppSelecao.Extensionista')),
            ],
            options={
                'managed': True,
                'db_table': 'frequencia',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='AppSelecao.Workshop'),
        ),
    ]
